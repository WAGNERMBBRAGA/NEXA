...
As dez capturas enviadas resultaram em sete imagens únicas. As repetições foram identificadas por comparação SHA-256 e não foram incluídas na galeria. Os arquivos publicados preservam o conteúdo e a resolução dos originais, inclusive as setas adicionadas pelo autor.
